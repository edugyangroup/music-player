...
const App = ({navigation}) => {
  ...
  <Text style={{fontSize:16,fontWeight:'bold',color:'#fff',textAlign:"center",width:240}}>Story</Text>
    </View>
    <View style={{margin:19}}>
    <Image style={{width:96,height:96,borderBottomRightRadius:30,borderRadius:8}} source={require('./add.png')} />
            <Text style={{fontSize:12,color:"#fff",fontWeight:"bold",paddingTop:5}}>{"New Story"}</Text>
    </View>
      <FlatList
      style={{padding:6}}
        data={dataSource}
